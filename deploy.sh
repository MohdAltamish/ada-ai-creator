...
for env_pair in \
  ...
  "FEATHERLESS_API_KEY=rc_83c0b2f2e70e06d3c780fda78ba892b855c186e6de5813551dbb7a4e5d597077" \
  "FEATHERLESS_MODEL=deepseek-ai/DeepSeek-V4-Flash-0731" \
  "FEATHERLESS_CLIENT_ID=${FEATHERLESS_CLIENT_ID:-YOUR_CLIENT_ID}" \
  "FEATHERLESS_CLIENT_SECRET=${FEATHERLESS_CLIENT_SECRET:-YOUR_CLIENT_SECRET}" \
